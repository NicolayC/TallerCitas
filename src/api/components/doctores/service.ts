import { DoctorUpdateError, DoctorDeleteError, RecordNotFoundError } from '../../../config/customErrors'
...
export class DoctorServiceImpl implements DoctorService {
    ...
    public async updateDoctor(id: number, updates: Partial<Doctor>): Promise<Doctor> {
        try {
